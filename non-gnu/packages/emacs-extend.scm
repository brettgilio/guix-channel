...
(define-public emacs-doom-modeline-tagged
  (let ((commit "ee4619d3670830180ffd87b1598d74312b5b9808")
        (revision "6"))
    (package
     ...
     (source (origin
              ...
              (sha256
               (base32
                "0r1nr2q0nscjp01k3hg32difxc12ck0qk0fpkc23lwx12g3x45y8"))
              (file-name (git-file-name name version))))
     (build-system emacs-build-system)
     (propagated-inputs
...
(define-public emacs-racket-mode-master
  (let ((commit "6fb1cde8749a394e7f7c67a70a4b807e319e4a38")
        (revision "6"))
    (package
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0a9b9gqnzg6lifsf5vbccrfj64avfi89zfg7q4z43sji75igrk7x"))))
      (build-system emacs-build-system)
      (arguments
       `(#:include '("\\.el$" "\\.rkt$")))
      (propagated-inputs
